...
def find_candidate_node():
    input_path = os.path.join(".", "AST", "output", "inheritance_node.json")
    ...
    input_path = os.path.join(".", "AST", "output", "no_inheritance_node.json")
    if os.path.exists(input_path):
        with open(input_path, 'r', encoding='utf-8') as f:
            data = json.load(f)
...
def find_external_candidates():
    find_candidate_node()
    output_path = os.path.join(".", "AST", "output", "external_candidates.json")
